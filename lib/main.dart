...
void main() async {
  ...
  await Firebase.initializeApp(
    // αρχικοποιούμε το Firebase με τις ρυθμίσεις που έχουμε στο αρχείο firebase_options.dart
    options: DefaultFirebaseOptions
        .currentPlatform, // επιλέγουμε τις ρυθμίσεις ανάλογα με την πλατφόρμα που τρέχει η εφαρμογή
  );
              ...
              final userData =
                  snapshot.data?.data()
                      as Map<
                        String,
                        dynamic
                      >?; // παίρνουμε τα δεδομένα του χρήστη από το Firestore
              final onboardingCompleted =
                  userData?['onboarding_completed'] ??
                  false; // ελέγχουμε αν έχει ολοκληρωθεί το onboarding
