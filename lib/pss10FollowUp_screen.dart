...
class Pss10FollowUpSsceen extends StatefulWidget {
  const Pss10FollowUpSsceen({Key? key}) : super(key: key);

  @override
  State<Pss10FollowUpSsceen> createState() => _Pss10FollowUpSsceenState();
}

class _Pss10FollowUpSsceenState extends State<Pss10FollowUpSsceen> {
  ...
  final List<int> _questionsToReverse = [3, 4, 6, 7]; // ερωτήσεις που χρειάζονται αντίστροφη βαθμολόγηση (0->4, 1->3, 2->2, 3->1, 4->0)
  final List<String> _answerLabels = ['Ποτέ', 'Σπάνια', 'Μερικές φορές', 'Αρκετά συχνά', 'Πολύ συχνά'];
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        if (mounted) {
          ...
          if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Κάτι πήγε στραβά, δοκίμασε ξανά σε λίγο. Σφάλμα: $e')));
        }
        finally {
          ...
          child: _isLoading
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Όπως και την πρώτη φορά, απλά απάντησε αυθόρμητα! Δεν υπάρχουν σωστές και λάθος απαντήσεις...',
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(color: const Color.fromARGB(255, 25, 96, 25), fontSize: 13),
                            ),
                            const SizedBox(height: 8),
                            Text(
                              questionText,
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? const Color.fromARGB(255, 25, 96, 25) : Colors.transparent,
            border: Border.all(
