...
class ApiService {
  ...
  final String apiUrl =
      'http://localhost:5000/analyze_stress'; // για test στον υπολογιστή
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "survey": {"v1": vibeCheck1, "v2": vibeCheck2, "v3": vibeCheck3},
          "health": {
            "steps": steps,
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Αποτυχία ανάλυσης στρες. Κωδικός κατάστασης: ${response.statusCode}',
        );
      }
    } catch (e) {
